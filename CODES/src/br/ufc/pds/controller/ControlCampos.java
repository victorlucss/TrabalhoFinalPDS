...
public class ControlCampos {
    ...
    public Map criarCampos() {
        ...
        campos.put(16, FactoryCompanhia.getInstance().criar("COMPANHIA DE TAXI", 16, 150, dono, 40, 23, 337));
        ...
        campos.put(26, FactoryCompanhia.getInstance().criar("COMPANHIA DE NAVEGAÇÃO", 26, 150, dono, 40, 340, 15));
